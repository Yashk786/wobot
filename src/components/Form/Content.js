...
const styles = {
  wrapper:
    "bg-gradient-to-r from-white via-[#e5e5e5] to-[#e5e5e5] h-fit flex flex-col w-full py-[1rem] px-[2rem] ",
  ...
  div: "absolute w-[800px] h-[13.44px] left-[-124.11px] top-[440px] bg-[#E0E8FC] rotate-[-30deg]",
  line: "absolute w-[531px] h-[13.44px] left-[850px] top-[430px] bg-[#3766E8] opacity-20 rotate-[-30deg]",
};
